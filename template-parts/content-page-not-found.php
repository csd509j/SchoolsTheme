		...
		<div id="search-form">
			<form role="search" id="sites-search" class="row no-gutters" action="<?php echo esc_url( home_url( '/' ) ); ?>" method="get">
				<div class="form-group col-md-9 col-lg-10 mb-1 mb-md-0">
					...
					<input type="text" class="form-control-lg w-100" id="search-text" placeholder="<?php __('Search','csdschools'); ?>..." value="<?php echo get_search_query(); ?>" name="s">
				</div>
...
<div class="row entry-content padding-top-two">
	<div class="col-md-4 col-sm-offset-1">
		<h3><?php _e('Popular Pages','csdschools'); ?></h3>
	...
	<div class="col-md-4">
		<h3><?php _e('Popular Resources','csdschools'); ?></h3>
		<ul class="list list-flush">
	...
	<div class="col-md-4">
		<h3><?php _e('School Information','csdschools'); ?></h3>
		<p><?php the_field('contact_us_text', 'option'); ?></p>
		
		<?php the_field('street_address', 'options'); ?><br>	
		
		<?php the_field('primary_phone', 'options'); ?> - <?php _e('Office','csdschools'); ?><br>
		
		<?php the_field('attendance_phone', 'options'); ?> - <?php _e('Attendance','csdschools'); ?><br>
